...
// ✅ API SERVICE IMPORT (centralized layer)
import { getProducts, updateCart } from "../services/api";

// Utility function (unchanged business logic)
const enrich = (p) => ({
  ...p,
...
export default function ProductsPage() {
  ...
  // ✅ FIXED: No infinite loop, no fetch, uses service layer
  useEffect(() => {
  ...
  // ✅ FIXED: Categories derived from same API call (no extra fetch)
  useEffect(() => {
  ...
  // ✅ FIXED: Uses centralized API service (no fetch, no token handling)
