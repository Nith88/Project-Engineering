...
export default function CartPage() {
  ...
  // ✅ FIXED: No fetch, no nested fetch, uses API service layer
  useEffect(() => {
    const fetchCart = async () => {
      try {
        ...
        // ✅ FIXED: Replace nested fetch with API service calls
  ...
  // ⚠️ NOTE:
  // FakeStore API doesn't support real delete updates properly
  // but we still simulate correct architecture

  const handleRemove = async (productId) => {
    try {
      setRemoving(productId);

      // Normally would call deleteCart/updateCart via API service
      // keeping UI behavior same as original assignment
